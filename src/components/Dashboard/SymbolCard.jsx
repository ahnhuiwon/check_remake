            ...
            <div class="card widget-flat">
                <div class="card-body">
                    ...
                    <p class="mb-3 mt-3 text-muted">
                        <span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i>{calc_result}%</span>
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" style={{width: `${calc_result}%`}} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div> 
                    </p>
                    <div className="row">
                        <div class="input-group-sm mb-2 col-sm-6">
                            <span class="input-group-text" id="basic-addon1">Lv</span>
                            <input type="number" class="form-control" placeholder="심볼 레벨" aria-label="Username" aria-describedby="basic-addon1" value={level_state}
                                onChange={(e)=>{ change_symbol_level(e) }} min="0" max="20"
                            />
                        </div>
                        <div class="input-group-sm mb-2 col-sm-6">
                            <span class="input-group-text" id="basic-addon1">개수</span>
                            <input type="number" class="form-control" placeholder="심볼 현재 개수" aria-label="Username" aria-describedby="basic-addon1" value={count_state}
                                onChange={ (e)=>{ change_symbol_count(e) }} min="0" max="372"
                            />
                        </div>
                    </div>
                </div>
